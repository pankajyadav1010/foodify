// Cart.jsx - Shopping cart page with quantity controls and checkout
      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h2 className="text-white fw-bold mb-0" style={{ fontFamily: "'Poppins', sans-serif" }}>
            🛒 Your Cart
            <span className="badge ms-2" style={{ background: "#e94560", fontSize: "0.7rem", verticalAlign: "middle" }}>
              {getItemCount()} items
            </span>
          </h2>
          <button
            ...
            style={{ border: `1px solid ${clearConfirm ? "#e94560" : "#30363d"}`, color: clearConfirm ? "#e94560" : "rgba(255,255,255,0.5)", background: "transparent", borderRadius: "8px" }}
          >
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            ...
            >
              {cartItems.map((item, index) => (
                ...
                >
                  {/* Item Image */}
                  <img
                    src={item.image || `https://via.placeholder.com/80x80/1e2a3a/e94560?text=${encodeURIComponent(item.name[0])}`}
                    alt={item.name}
                    style={{ width: "80px", height: "80px", objectFit: "cover", borderRadius: "12px", flexShrink: 0 }}
                    onError={(e) => {
                      e.target.src = `https://via.placeholder.com/80x80/1e2a3a/e94560?text=${encodeURIComponent(item.name[0])}`;
                    }}
                  />
                  ...
                  <div className="flex-grow-1 min-width-0">
                    ...
                    <span
                      className="badge"
                      style={{ background: "rgba(233,69,96,0.2)", color: "#e94560", fontSize: "0.7rem" }}
                    >
                      {item.category}
                    </span>
                    <div className="text-white mt-1" style={{ fontSize: "0.95rem", fontWeight: 600 }}>
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <button
                      ...
                      style={{ background: "#1e2a3a", color: "white", border: "1px solid #30363d", borderRadius: "8px", width: "32px", height: "32px" }}
                    >
                      <FiMinus size={14} />
                    </button>
                    ...
                    <button
                      className="btn btn-sm p-1"
                      onClick={() => updateQuantity(item.id, item.quantity + 1)}
                      style={{ background: "#e94560", color: "white", border: "none", borderRadius: "8px", width: "32px", height: "32px" }}
                    >
                      <FiPlus size={14} />
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    style={{ background: "rgba(233,69,96,0.1)", color: "#e94560", border: "none", borderRadius: "8px", padding: "8px" }}
                  >
                    <FiTrash2 size={16} />
                  </button>
                </div>
            ...
            <Link
              to="/"
              className="btn mt-3"
              style={{ color: "#e94560", background: "transparent", border: "1px solid #e94560", borderRadius: "12px", textDecoration: "none" }}
            >
              ← Continue Shopping
            </Link>
          </div>
